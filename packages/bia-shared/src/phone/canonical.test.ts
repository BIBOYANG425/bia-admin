...
import { canonicalizePhone } from "./canonical";
import vector from "./canonical.vector.json";
...
// THE cross-repo parity contract. george and bia-roommate both import
// canonicalizePhone + canonical.vector.json from @biboyang425/bia-shared/phone
// and run this same assertion loop, so the repos' phone normalization can
// never drift.
