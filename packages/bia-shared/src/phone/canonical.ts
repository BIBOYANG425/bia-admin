...
// zero internal imports so every consumer (george, bia-roommate, bia-admin)
// runs the exact same logic. Do not add any local imports here — the parity
// test vector (canonical.vector.json) is the cross-repo no-drift contract that
// every repo runs against this code.
//
// Verbatim copy of george's src/services/phone-canonical.ts. This package is
// now the single cross-repo source of truth: @biboyang425/bia-shared/phone.
//
